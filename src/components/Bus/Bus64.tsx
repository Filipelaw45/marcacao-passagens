...
interface Bus64Props {
  trip: Trip;
}

export function Bus64({ trip }: Bus64Props) {
            ...
            <section className=' h-full flex-1 flex flex-wrap justify-center'>
              {Array.from({ length: upperDeckFirstColumn.length }).map((_, index) => {
                const passenger = trip.passengers.find(
                  (p) => p.seat === upperDeckFirstColumn[index]
                );
                return (
                  <div key={upperDeckFirstColumn[index]}>
                    {passenger ? (
                      <Seats sex={passenger.sex} id={upperDeckFirstColumn[index]} />
                    ) : (
                      <Seats id={upperDeckFirstColumn[index]} />
                    )}
                  </div>
                );
              })}
              ...
              {Array.from({ length: upperDeckSecondColumn.length }).map((_, index) => {
                ...
                return (
                  <div key={upperDeckSecondColumn[index]}>
                    {passenger ? (
                      <Seats sex={passenger.sex} id={upperDeckSecondColumn[index]} />
                    ) : (
                      <Seats id={upperDeckSecondColumn[index]} />
                    )}
                  </div>
                );
              })}
              ...
              {Array.from({ length: upperDeckSecondColumn2.length }).map((_, index) => {
                ...
                return (
                  <div key={upperDeckSecondColumn2[index]}>
                    {passenger ? (
                      <Seats sex={passenger.sex} id={upperDeckSecondColumn2[index]} />
                    ) : (
                      <Seats id={upperDeckSecondColumn2[index]} />
                    )}
                  </div>
                );
              })}
                ...
                {Array.from({ length: lowerDeckFirstColumn.length }).map((_, index) => {
                  ...
                  return (
                    <div key={lowerDeckFirstColumn[index]}>
                      {passenger ? (
                        <Seats sex={passenger.sex} id={lowerDeckFirstColumn[index]} />
                      ) : (
                        <Seats id={lowerDeckFirstColumn[index]} />
                      )}
                    </div>
                  );
                })}
                ...
                {Array.from({ length: lowerDeckSecondColumn.length }).map((_, index) => {
                  ...
                  return (
                    <div key={lowerDeckSecondColumn[index]}>
                      {passenger ? (
                        <Seats sex={passenger.sex} id={lowerDeckSecondColumn[index]} />
                      ) : (
                        <Seats id={lowerDeckSecondColumn[index]} />
                      )}
                    </div>
                  );
                })}
